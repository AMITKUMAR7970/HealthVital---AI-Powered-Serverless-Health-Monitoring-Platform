# Create a comprehensive deployment guide and infrastructure-as-code templates
deployment_guide = {
    "aws_lambda_functions": {
        "patient_data_processor": {
            ...
            "environment_variables": {
                "DYNAMODB_TABLE": "HealthVital-Patients",
                "IOT_ENDPOINT": "${aws_iot_core_endpoint}",
                "ENCRYPTION_KEY": "${kms_key_id}"
            },
            "iam_role": "HealthVital-Lambda-Execution-Role"
        },
        "ai_analytics_processor": {
            "runtime": "python3.11",
            ...
            "environment_variables": {
                ...
                "S3_BUCKET": "healthvital-ml-models",
                "REDSHIFT_CLUSTER": "${redshift_cluster_endpoint}"
            }
        },
        "iot_data_ingestion": {
            "runtime": "nodejs18.x",
            ...
            "timeout": 15,
            "environment_variables": {
                "KINESIS_STREAM": "HealthVital-IoT-Stream",
                "DYNAMODB_TABLE": "HealthVital-DeviceData"
            }
        },
        "notification_service": {
            ...
            "environment_variables": {
                ...
                "SES_DOMAIN": "healthvital.com"
            }
        }
    },
    "api_gateway_configuration": {
        "rest_api_name": "HealthVital-API",
        "stage": "prod",
        "resources": [
            "/patients",
            "/patients/{patientId}",
...
# Save the SAM template
with open('template.yaml', 'w') as f:
    f.write(sam_template)

print("AWS SAM template created: template.yaml")
print("Template includes:")
print("- 4 Lambda functions for different services")
print("- API Gateway with Cognito authorization")
print("- DynamoDB tables with proper indexing")
print("- Kinesis stream for IoT data")
print("- SNS topic for notifications")
print("- S3 buckets for storage")
print("- CloudFront distribution")
print("- IAM roles and policies")
print("- Proper environment separation")